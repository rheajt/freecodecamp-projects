...
function zoomstart() {
    ...
    countryNodes.classed("selected", false);
}
...
var brusher = d3.svg.brush()
  ...
  .on("brush", function() {
      ...
      countryNodes.classed("selected", function(d) {
...
d3.json("countries.json", function(error, graph) {
    ...
    function dragstarted(d) {
        ...
        if (!d.selected && !shiftKey) {
          ...
          countryNodes.classed("selected", function(p) { return p.selected =  p.previouslySelected = false; });
        }

        d3.select(this).classed("selected", function(p) { d.previouslySelected = d.selected; return d.selected = true; });

        countryNodes.filter(function(d) { return d.selected; })
    ...
    var country = countryNodes.data(graph.nodes).enter().append('g')
      .attr('class', 'country');

    var flag = country.append('foreignObject')
        .attr('class', function(d) { return 'flag flag-' + d.code; })
        .attr('x', function(d) {return d.x; })
        .attr('y', function(d) { return d.y; })
        .attr('height', function(d) {return 11;})
        .attr('width', function(d) {return 16;})

    countryNodes.append("rect")
      ...
      .on("click", function(d) {
          ...
          if (!shiftKey) {
              ...
              flag.classed("selected", function(p) { return p.selected =  p.previouslySelected = false; })
          }
